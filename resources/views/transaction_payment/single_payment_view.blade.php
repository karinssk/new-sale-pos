      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            ...
            @elseif($single_payment_line->method == "bank_transfer")
              @if(!empty($single_payment_line->bank_name))
                <strong>Bank Name :</strong> {{ $single_payment_line->bank_name }} <br>
              @endif
              @if(!empty($single_payment_line->bank_account_number))
                <strong>@lang('lang_v1.bank_account_number') :</strong> {{ $single_payment_line->bank_account_number }} <br>
              @endif
              @if(!empty($single_payment_line->bank_logo_url))
                <strong>Bank Logo :</strong><br>
                <img src="{{ $single_payment_line->bank_logo_url }}" alt="Bank Logo" style="max-height: 50px; max-width: 120px;">
              @endif
