				...
				<div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-7 @else col-md-10 col-md-offset-1 @endif no-padding pr-12">
					<div class="box box-solid mb-12 @if(!isMobile()) mb-40 @endif">
						<div class="box-body pb-0">
							...
							<!-- Transaction status and sub_status for proper status determination -->
							{!! Form::hidden('transaction_status', $transaction->status, ['id' => 'transaction_status']) !!}
							{!! Form::hidden('transaction_sub_status', $transaction->sub_status, ['id' => 'transaction_sub_status']) !!}
							{!! Form::hidden('transaction_is_quotation', $transaction->is_quotation, ['id' => 'transaction_is_quotation']) !!}
							<!-- Debug values -->
							<!-- Status: {{ $transaction->status }}, Sub Status: {{ $transaction->sub_status }}, Is Quotation: {{ $transaction->is_quotation }} -->
