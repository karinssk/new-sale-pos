  ...
  .wrapper {
    ...
    <style>
        ...
        table td, table th {
            ...
            z-index: 9999;
                vertical-align: top;
            word-wrap: break-word; /* รองรับข้อความยาว */
...
.summary-table .total-value td {
    text-align: center;
    font-size: 28px;     /* ตัวใหญ่พิเศษ */
    font-weight: bold;
    padding: 12px 0;
}
...
<div class="remark">
 ...
 <p class="remark-warning" id="warning">* ใบเสร็จรับเงินจะสมบูรณ์ต่อมเมื่อบริษัท หจก.รูบี้ช๊อป ได้รับเงินตามเช็คหรือเงินโอนเข้าบัญชีเรียบร้อยแล้ว</p>
...
<div class="wrapper">       
 <table class="vertical-text">        
        ...
        <div class="products-section">
            ...
            <table>
                <tr class="table-header">
                    <td width="60%" class="textcolor">Description of Services and Goods</td>
                    <td width="10%" class="text-center textcolor">Quantity</td>
                    <td width="25%" class="text-center textcolor">Price Per Unit(Baht)</td>
                    <td width="15%" class="text-center textcolor">Amount</td>
                </tr>
    ...
    <table>
        ...
        <!-- แถวสุดท้าย -->
        <tr class="total-row">
            <td colspan="2" class="total-label">Total Price/ราคารวมสุทธิ</td>
        </tr>
        <tr class="total-value">
            <td colspan="2">
                <span>{{ $is_multi_page ? '' : $receipt_details->total }}</span> บาท
            </td>
        </tr>
    </table>
</div>
