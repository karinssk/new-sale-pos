      		...
      		@if(session('business.enable_racks') || session('business.enable_row') || session('business.enable_position') || session('business.enable_level'))
      			<div class="row">
      				...
      				<div class="col-md-12">
      					...
      					<table class="table table-condensed bg-gray table-striped">
      						<thead>
      						<tr class="bg-green">
      							<th><strong>@lang('business.location')</strong></th>
      							@if(session('business.enable_racks'))
      								<th><strong>@lang('lang_v1.rack')</strong></th>
      							@endif
      							@if(session('business.enable_row'))
      								<th><strong>@lang('lang_v1.row')</strong></th>
      							@endif
      							@if(session('business.enable_position'))
      								<th><strong>@lang('lang_v1.position')</strong></th>
      							@endif
      							@if(session('business.enable_level'))
      								<th><strong>@lang('lang_v1.level')</strong></th>
      							@endif
      						</tr>
      						</thead>
      						<tbody>
