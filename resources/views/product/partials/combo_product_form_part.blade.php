	...
	<div class="col-sm-12">
					...
					<tr>
						...
						<td class="text-center">
							<span class="item_level_purchase_price_total display_currency" data-currency_symbol="true">
								{{ @num_format(isset($default_purchase_price) ? $default_purchase_price : 0) }}
							</span>
							<input type="hidden" name="item_level_purchase_price_total" id="item_level_purchase_price_total" value="{{ isset($default_purchase_price) ? $default_purchase_price : 0 }}">
							<input type="hidden" name="purchase_price_inc_tax" id="purchase_price_inc_tax" value="{{ isset($default_purchase_price_inc_tax) ? $default_purchase_price_inc_tax : 0 }}">
						</td>
					</tr>
				</tfoot>	
			</table>
		...
		<div class="col-sm-12 col-sm-offset-4">
			...
			<div class="col-sm-4">
				...
				{!! Form::text('selling_price', @num_format(isset($default_selling_price) ? $default_selling_price : 0), ['class' => 'form-control input-sm input_number mousetrap']) !!}

				{!! Form::hidden('selling_price_inc_tax', @num_format(isset($default_selling_price_inc_tax) ? $default_selling_price_inc_tax : 0), ['class' => 'input_number mousetrap', 'id' => 'selling_price_inc_tax']) !!}
			</div>
		</div>
	</div>
</div>
