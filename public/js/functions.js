...
function init_tinymce(editor_id) {
    ...
    if (!document.compatMode || document.compatMode === 'BackCompat') {
        console.error('TinyMCE initialization failed: Document is not in standards mode');
        console.log('Current document.compatMode:', document.compatMode);
        return false;
    }
        ...
        tinymce.init({
            ...
            setup: function(editor) {
                editor.on('init', function() {
                    console.log('TinyMCE editor initialized successfully for:', editor_id);
                });
