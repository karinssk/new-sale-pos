...
class Transaction extends Model
{
    ...
    {
        return $this->belongsTo(\App\CustomerSource::class, 'customer_source_id');
    }

    public function responsible_salesperson()
    {
        return $this->belongsTo(\App\User::class, 'responsible_salesperson_id');
    }
