...
class TransactionPayment extends Model
{
    ...
    /**
     * Public URL for uploaded bank logo, if present.
     */
    public function getBankLogoUrlAttribute()
    {
        ...
        // Prefer storage path, but fall back to public/img/bank_logo for bundled assets
        $storagePath = public_path('storage/img/bank_logo/'.$this->bank_logo);
        if (file_exists($storagePath)) {
            return asset('storage/img/bank_logo/'.$this->bank_logo);
        }

        $publicPath = public_path('img/bank_logo/'.$this->bank_logo);
        if (file_exists($publicPath)) {
            return asset('img/bank_logo/'.$this->bank_logo);
        }
