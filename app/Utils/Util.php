...
class Util
{
    ...
    public function payment_types($location = null, $show_advance = false, $business_id = null)
    {
        ...
        // Explicitly hide custom payment placeholders 1-7 for this deployment
//         159
...
//         $payment_types['custom_pay_7'] = ! empty($custom_labels['payments']['custom_pay_7']) ? $custom_labels['payments']['custom_pay_7'] : __('lang_v1.custom_payment', ['number' => 7]);
        ...
        if (! empty($location)) {
            ...
            // Only filter when the location explicitly enabled some methods.
            // If nothing is configured, keep all defaults instead of stripping everything.
