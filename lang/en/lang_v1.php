...
return [
    ...
    'rack_details' => 'Rack/Row/Position/Level Details',
    ...
    'level_help_text' => "Level details seperated by '|' for different business locations serially.<br/> (Ex: 1|2|3) ",
    ...
    // Document workflow language keys
    'proforma_created_successfully' => 'Proforma invoice :invoice_no created successfully',
    'final_bill_created_successfully' => 'Final bill :invoice_no created successfully',
    'document_types' => 'Document Types',
    'final_bills_ipay' => 'Final Bills (IPAY)',
    'tax_invoice_vt' => 'Tax-Invoice (VT)',
    'quick_action' => 'Quick Action',
    'create_tax_invoice' => 'Create Tax-Invoice (Proforma)',
    'create_billing_receive' => 'Create Billing-receive',
    'tax_invoice_created_successfully' => 'Tax-Invoice (Proforma) created successfully with number: :invoice_no',
    'billing_receive_created_successfully' => 'Billing-receive created successfully with number: :invoice_no',
    
    // Summary Sales
    'summary_sales' => 'Summary Sales',
    'final_bills' => 'Final Bills',
    'proforma_invoices' => 'Proforma Invoices',
    'summary_sales_description' => 'This page shows only Final Bills (IPAY) and Proforma Invoices (VT) with enhanced filtering options.',
    'summary_sales_shows_both_types' => 'This page always shows both Final Bills and Proforma Invoices',
